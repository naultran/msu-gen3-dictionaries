...
def create_study(
    ...
    {{
        ...
        "test_article_dtxsid": "{test_article_type}",
        "type": "{node_type}"
    }}
    """
...
def main():
    parser = argparse.ArgumentParser(description="Create Gen3 Study")
    ...
    parser.add_argument("--test_article", required=True,
                        help="Test article")

    parser.add_argument("--test_article_type", required=True,
                        help="Test article type")
